...
* The original package name 'com.mouensis.server.mouensis-identity-server' is invalid and this project uses 'com.mouensis.server.mouensisidentityserver' instead.
