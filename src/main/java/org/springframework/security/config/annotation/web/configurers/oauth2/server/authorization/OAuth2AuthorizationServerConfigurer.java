...
import com.mouensis.server.authorization.security.OAuth2PasswordAuthenticationProvider;
	...
	public void init(B builder) {
		...
		OAuth2PasswordAuthenticationProvider passwordAuthenticationProvider =
				new OAuth2PasswordAuthenticationProvider(
						getAuthorizationService(builder),
						jwtEncoder);
		builder.authenticationProvider(postProcess(passwordAuthenticationProvider));
